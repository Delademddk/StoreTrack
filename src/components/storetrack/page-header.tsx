...
export function StatusBadge({ status }: { status: "in_stock" | "low_stock" | "out_of_stock" }) {
  const map = {
    ...
    low_stock: { label: "Low stock", cls: "bg-warning/15 text-warning-foreground ring-warning/30 dark:text-warning" },
    out_of_stock: { label: "Out of stock", cls: "bg-destructive/10 text-destructive ring-destructive/20" },
  } as const;
